...
%% 2) Define reference colors and values
...
%% 7) Display distribution (high to low)
...
%% 8) Compute mean visibility directly (better than midpoint approximation)

v_mean = mean(estimated_value);

fprintf('\nMean Visibility = %.4f\n', v_mean);

%% 9) Compute average solar flux
