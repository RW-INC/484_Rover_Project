function [state_hat, P] = translational_ekf_fixed(IMU, UWB, orientation_estimate, u, prior_estimate, prior_P, rot_P, dt)
    ...
    R = diag([0.03^2, 0.03^2, 0.03^2, 0.003^2, 0.003^2, 0.003^2, 0.01^2, 0.001^2, rot_P(1,1), rot_P(2,2)]); 
    %R = diag(ones(8) * 0.01);
    ...
    state_hat = state_hat_pred + K * ([IMU; UWB; yaw; pitch] - [state_hat_pred; rho_pred; alpha_pred / rho_pred; yaw; pitch]);
    P = (eye(6) - K * H) * P_pred;
end
